...
export class JobApplicationFormComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.http.get<any>(`https://job-portal-2-gja0.onrender.com/api/jobs/${this.jobId}`).subscribe({
      next: (job) => {
  ...
  onSubmit() {
    ...
    this.http.post(`https://job-portal-2-gja0.onrender.com/api/applications/${this.jobId}/apply`, this.applicant).subscribe({
      next: () => {
